...
const InlineCSS = () => {
 ...
 return (
  <ContentBox title="Inline CSS" codeString={codeString} codeTitle="Inline CSS" codeLang="html">
   ...
   <List>
    <li>
     <strong>Lack of Separation:</strong> Inline CSS mixes HTML content with styling information, which can make the HTML code less readable and harder to maintain. It doesn't follow the separation of
     concerns principle, where HTML should define the structure, and CSS should handle the presentation.
    </li>
    <li>
     <strong>Limited Reusability:</strong> Inline styles are not reusable across multiple elements. If you want the same style applied to multiple elements, you'd need to duplicate the same inline CSS
     for each element, leading to code redundancy.
    </li>
    <li>
    ...
    <li>
     <strong>Maintenance Challenges:</strong> If you want to make global style changes or update a consistent design across your website, it's much more efficient to use an external stylesheet or a{" "}
     <TagDesign title="style" /> tag in the HTML head.
    </li>
   </List>
  </ContentBox>
 )
